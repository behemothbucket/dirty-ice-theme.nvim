...
local highlight_groups = {
  ...
  ["@text.warning"]                  = { fg = p.warning_fg, bg = p.yellow_m1 },
  ["@text.danger"]                   = { fg = p.danger, bg = p.red_m1 },
  ...
  ["@js.template_string_identifier"] = { link = "@variable" },
  -- Diff
